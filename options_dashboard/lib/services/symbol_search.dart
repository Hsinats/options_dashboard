...
class CompanySymbolSearch extends SearchDelegate<Company> {
  final searchFieldLabel = 'Search a symbol';
  ...
  List<Widget> buildActions(BuildContext context) {
    return [
      IconButton(
          ...
          onPressed: () {
            if (query.length < 10) {
              close(context, Company(null, query, null));
            }
          })
    ];
  }
    ...
    final suggestions = query.isEmpty
        ...
        : loadSNP(snp)
            .where((Company company) =>
                (company.name.contains(toSentenceCase(query)) ||
                    company.symbol.contains(query.toUpperCase())))
            .toList();
    return suggestions.isEmpty
        ? Column(
            children: [
              ListTile(
                title: Text(
                    'No companies found with ticker \$$query, search anyways?'),
                onTap: () {
                  if (query.length < 10) {
                    close(context, Company(null, query, null));
                  }
        ...
        : ListView.builder(
            ...
            itemBuilder: (context, index) {
              final Company suggestedCompany = suggestions[index];
              return ListTile(
                onTap: () {
                  query = suggestions[index].symbol;
                  close(context, suggestions[index]);
                },
                title: Text(suggestedCompany.name),
                subtitle: Text(suggestedCompany.symbol),
              );
            },
          );
  }
...
List<Company> loadSNP(List<Map<String, String>> jsonList) {
  List<Company> output = [];

  jsonList.forEach((company) {
    output.add(Company(company["Name"], company["Symbol"], company["Sector"]));
  });
...
class Company {
  ...
  Company(this.name, this.symbol, [this.sector]);
}

List<Map<String, String>> snp = [
  ...
  {"Name": "ABIOMED Inc", "Sector": "Health Care", "Symbol": "ABMD"},
  {
    "Name": "Accenture plc",
  ...
  {"Name": "Adobe Inc.", "Sector": "Information Technology", "Symbol": "ADBE"},
  {
  ...
  {"Name": "Amcor plc", "Sector": "Materials", "Symbol": "AMCR"},
  ...
  {"Name": "American Tower Corp.", "Sector": "Real Estate", "Symbol": "AMT"},
  {
  ...
  {"Name": "AT&T Inc.", "Sector": "Communication Services", "Symbol": "T"},
  ...
  {"Name": "Baker Hughes Co", "Sector": "Energy", "Symbol": "BKR"},
  ...
  {"Name": "Copart Inc", "Sector": "Industrials", "Symbol": "CPRT"},
  ...
  {"Name": "Dow Inc.", "Sector": "Materials", "Symbol": "DOW"},
  ...
  {"Name": "DuPont de Nemours Inc", "Sector": "Materials", "Symbol": "DD"},
  {
    "Name": "DXC Technology",
    "Sector": "Information Technology",
    "Symbol": "DXC"
  ...
  {"Name": "eBay Inc.", "Sector": "Consumer Discretionary", "Symbol": "EBAY"},
  ...
  {"Name": "Facebook Inc.", "Sector": "Communication Services", "Symbol": "FB"},
  ...
  {"Name": "HollyFrontier Corp", "Sector": "Energy", "Symbol": "HFC"},
  ...
  {"Name": "Linde plc", "Sector": "Materials", "Symbol": "LIN"},
  {
  ...
  {"Name": "MSCI Inc", "Sector": "Financials", "Symbol": "MSCI"},
  ...
  {"Name": "Newmont Corporation", "Sector": "Materials", "Symbol": "NEM"},
  {
  ...
  {"Name": "Nike Inc.", "Sector": "Consumer Discretionary", "Symbol": "NKE"},
  {"Name": "NiSource Inc.", "Sector": "Utilities", "Symbol": "NI"},
  {"Name": "Noble Energy", "Sector": "Energy", "Symbol": "NBL"},
  ...
  {"Name": "NVR Inc.", "Sector": "Consumer Discretionary", "Symbol": "NVR"},
  {
  ...
  {"Name": "Pentair plc", "Sector": "Industrials", "Symbol": "PNR"},
  {
  ...
  {"Name": "Rollins Inc.", "Sector": "Industrials", "Symbol": "ROL"},
  ...
  {"Name": "STERIS plc", "Sector": "Health Care", "Symbol": "STE"},
  ...
  {"Name": "Trane Technologies plc", "Sector": "Industrials", "Symbol": "TT"},
  ...
  {"Name": "Union Pacific Corp", "Sector": "Industrials", "Symbol": "UNP"},
  {
  ...
  {"Name": "Wabtec Corporation", "Sector": "Industrials", "Symbol": "WAB"},
  {
  ...
  {"Name": "Xerox", "Sector": "Information Technology", "Symbol": "XRX"},
